              ...
              <button
                ...
                className={classNames(
                  ...
                  settings.theme === theme
                    ...
                    : 'bg-bolt-elements-hover dark:bg-[#1A1A1A] text-bolt-elements-textSecondary hover:bg-orange-500/10 hover:text-orange-500 dark:hover:bg-orange-500/20 dark:text-bolt-elements-textPrimary dark:hover:text-orange-500',
                )}
              >
                <div
                  className={`w-4 h-4 ${
      ...
      >
        ...
        <div className="space-y-2">
          {Object.entries(useStore(shortcutsStore)).map(([name, shortcut]) => (
            <div
              key={name}
              className="flex items-center justify-between p-2 rounded-lg bg-[#FAFAFA] dark:bg-[#1A1A1A] hover:bg-orange-50 dark:hover:bg-orange-500/10 transition-colors"
            >
