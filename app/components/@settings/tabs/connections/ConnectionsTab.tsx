...
export default function ConnectionsTab() {
  ...
  return (
    <div className="space-y-4">
      ...
      >
        <div className="i-ph:plugs-connected w-5 h-5 text-orange-500" />
                  ...
                  <div className="flex flex-wrap gap-2">
                    {Object.entries(connection.stats.languages)
                      ...
                      .map(([language]) => (
                        <span
                          key={language}
                          className="px-3 py-1 text-xs rounded-full bg-orange-500/10 text-orange-500 dark:bg-orange-500/20"
                        >
                          {language}
                        </span>
                      ))}
