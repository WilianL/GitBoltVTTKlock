          ...
          <div className={classNames(styles.Chat, 'flex flex-col flex-grow lg:min-w-[var(--chat-min-width)] h-full')}>
            {!chatStarted && (
              <div id="intro" className="mt-[16vh] max-w-chat mx-auto text-center px-4 lg:px-0">
                ...
                Crie o que quiser, sem limitações. Sua mente é seu limite...
                </p>
              </div>
            )}
            <div
                ...
                >
                  <svg className={classNames(styles.PromptEffectContainer)}>
                    <defs>
                      ...
                      >
                        <stop offset="0%" stopColor="#ff8300" stopOpacity="0%"></stop>
                        <stop offset="40%" stopColor="#ff8300" stopOpacity="80%"></stop>
                        <stop offset="50%" stopColor="#ff8300" stopOpacity="80%"></stop>
                        <stop offset="100%" stopColor="#ff8300" stopOpacity="0%"></stop>
                      </linearGradient>
